...
const Navigation = () => {
	...
	return (
		<nav className="relative md:absolute bottom-0 md:bottom-auto md:top-0 left-0 flex max-w-[2560px] mx-auto w-full px-6 py-4 lg:py-8 lg:px-10 2xl:py-12 2xl:px-14 shadow-md justify-between items-center z-10 bg-background">
